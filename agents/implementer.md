...
tools: Bash, Glob, Grep, LS, Read, TodoWrite, WebFetch, WebSearch, Edit, Write, MultiEdit, ToolSearch, mcp__ape__ape_validate_receipt, mcp__plugin_ape_ape__ape_validate_receipt, mcp__*
