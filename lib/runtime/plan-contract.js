      ...
      if (!recognizedPlannedEvidenceCommand(
        ...
        errors.push(
          Array.isArray(context?.allowed_evidence_commands)
            ? `evidence.candidate_plan.workstreams.${workstreamIndex}.evidence_commands.${commandIndex} is not an exact member of ticket.capability_manifest.allowed_evidence_commands: ${command}`
