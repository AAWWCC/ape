...
describe('release 2.23.4 public packaging', () => {
  it('pins source and generated package surfaces to 2.23.4', () => {
    for (const relative of [
      ...
      expect(readJson(relative).version, relative).toBe('2.23.4');
    }
    expect(read('bin/ape-mcp.mjs')).toContain("version: '2.23.4'");
  });
