...
describe('release 2.24.5 public packaging', () => {
  it('pins source and generated package surfaces to 2.24.5', () => {
    for (const relative of [
      ...
      expect(readJson(relative).version, relative).toBe('2.24.5');
    }
    expect(read('bin/ape-mcp.mjs')).toContain("version: '2.24.5'");
  });
