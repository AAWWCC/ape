...
describe('release 2.19.0 public packaging', () => {
  it('pins source and generated package surfaces to 2.19.0', () => {
    for (const relative of [
      ...
      'plugins/ape-gemini/package.json',
      'plugins/ape-gemini/plugin.json',
    ]) {
      expect(readJson(relative).version, relative).toBe('2.19.0');
    }
    expect(read('bin/ape-mcp.mjs')).toContain("version: '2.19.0'");
  });
